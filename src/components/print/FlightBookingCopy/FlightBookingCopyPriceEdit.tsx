...
const FlightBookingCopyPriceEdit = ({
  bookingDetails,
  agent,
  editableTotals,
  passengerId,
  ...
  const totalNet = editableTotals?.reduce(
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={{ padding: "10px 0px" }}>
          ...
          <View style={styles.table}>
            ...
            {/* Table Rows */}
            {(passengerId
              ? bookingDetails?.passengers?.filter(
        ...
        <View>
          ...
          >
            ...
            >
              Grand Total: {commaNumber(totalNet.toFixed(2))}{" "}
              {bookingDetails?.currency}
            </Text>
          </View>
        </View>
...
export default FlightBookingCopyPriceEdit;
