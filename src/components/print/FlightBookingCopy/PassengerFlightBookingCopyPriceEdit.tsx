...
const PassengerFlightBookingCopyPriceEdit = ({
  bookingDetails,
  price,
  agent,
  editableTotals,
  ...
  const styles = StyleSheet.create({
    ...
    tableCol: {
      width: "20%", // Reduced width for other columns
      padding: 5,
    },
    passengerNameHeader: {
      width: "40%", // Larger width for the "Passenger Name" header
    },
    passengerNameCell: {
      width: "40%",
    },
  ...
  const filteredBaggage = bookingDetails.baggage.filter(
    (item: any) =>
      item.bookingPassengerType === passengerInformation[0]?.passengerType
  );

  const groupedBaggage = filteredBaggage?.reduce((acc: any, item: any) => {
  ...
  const grandTotal = passengerFareSummery?.reduce((total: any, fare: any) => {
    return (
      total +
      fare?.totalBaseFare +
      fare?.totalTax +
  ...
  const shouldRenderBreak = bookingDetails.originDestinationOptions.some(
    (option: any) => option.segments.length >= 3
  );
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={{ flexDirection: "row", gap: "8px", marginTop: "10px" }}>
          ...
          >
            ...
            >
              ...
              <View>
                ...
                >
                  {moment(bookingDetails?.issuedDateTime).format("Do-MMM-YY")}
                </Text>
              </View>
              <View>
                <Text
          ...
          >
            ...
            >
              {/* {passengerInformation[0]?.isSpilited === true
                ? passengerInformation[0]?.splitedAirlinesPNR
                : bookingDetails?.airlinesPNR} */}

              {passengerInformation[0]?.isSplited === true
                ? passengerInformation[0]?.splitedAirlinesPNR
                : bookingDetails?.airlinesPNR}
            </Text>
          </View>
        ...
        <View style={{ padding: "10px 0px" }}>
          ...
          <View style={styles.table}>
              ...
              <View style={[styles.tableCol, styles.passengerNameHeader]}>
                <Text
                  style={[
                    ...
                    { alignSelf: "flex-start", paddingLeft: "30px" },
                  ]}
                >
                  Passenger Name
                </Text>
            ...
            {/* Table Rows */}
            {passengerInformation?.map((data: any, index: any) => (
          ...
          <View>
            <View style={{ padding: "10px 0px" }}>
              ...
              <View style={styles.table}>
                ...
                {passengerFareSummery?.map((total: any, index: number) => (
                  <View style={styles.tableRow} key={index}>
                    <View style={styles.tableCol}>
                      <Text style={styles.tableBodyCell}>
                    ...
                    <View style={styles.tableCol}>
                      <Text style={styles.tableBodyCell}>1</Text>
                    </View>
                    <View style={styles.tableCol}>
                      <Text style={styles.tableBodyCell}>
                        {commaNumber(+total.subTotal)}
                      </Text>
                    </View>
                  </View>
                ))}
            ...
            >
              ...
              >
                AIT & VAT:{" "}
                {commaNumber(
                  (passengerFareSummery[0]?.userAIT || 0).toFixed(2)
                )}{" "}
            ...
            >
              ...
              >
                Grand Total: {commaNumber(grandTotal.toFixed(2))}{" "}
                {bookingDetails?.currency}
              </Text>
            </View>
          </View>
...
export default PassengerFlightBookingCopyPriceEdit;
