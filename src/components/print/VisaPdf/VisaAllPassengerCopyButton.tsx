...
const VisaAllPassengerCopyButton = ({ setOpenDownloadModal, booking }: any) => {
  ...
  const handleViewPDF = async () => {
    const blob = await pdf(
      <VisaAllPassengerCopy agent={agent} booking={booking} />
    ).toBlob();
...
export default VisaAllPassengerCopyButton;
