...
const VisaAllPassengerCopyFare = ({ agent, booking }: any) => {
      ...
      <Page size="A4" style={styles.page}>
                ...
                <View style={styles.tableCol}>
                  <Text style={styles.tableBodyCell}>
                    {passenger.passportExpiryDate
                      ? moment(passenger.passportExpiryDate).format(
                          "DD-MMM-YYYY"
                        )
                      : ""}
                  </Text>
        ...
        <View>
          <View style={{ padding: "10px 0px" }}>
            ...
            <View style={styles.table}>
              ...
              <View style={styles.tableRow}>
                <View style={styles.tableColFareSummery}>
                  <Text style={styles.tableBodyCell}>
                    {commaNumber(booking?.userVisaFee)}
                  </Text>
                </View>
                <View style={styles.tableColFareSummery}>
                  <Text style={styles.tableBodyCell}>
                    {commaNumber(booking?.userServiceFee)}
                  </Text>
                </View>

                <View style={styles.tableColFareSummery}>
                  <Text style={styles.tableBodyCell}>
                    {commaNumber(booking?.userPayable)}
                  </Text>
                </View>
              </View>
            </View>
          ...
          >
            ...
            >
              Total amount: {commaNumber(booking.userPayable)}{" "}
              {booking?.currency}
            </Text>
          </View>
          <View
          ...
          >
            ...
            >
              Paid amount: {commaNumber(booking?.paidAmount)}{" "}
              {booking?.currency}
            </Text>
          </View>
          <View
          ...
          >
            ...
            >
              Due amount:{" "}
              {commaNumber(
                Number(booking?.userPayable) - Number(booking?.paidAmount)
              )}{" "}
              {booking?.currency}
            </Text>
          </View>
          ...
          >
            ...
            >
              Grand Total: {commaNumber(booking.userPayable)}{" "}
              {booking?.currency}
            </Text>
          </View> */}
        </View>
...
export default VisaAllPassengerCopyFare;
