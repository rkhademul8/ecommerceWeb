  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {flightData?.map((data: any, index: any) => (
          <View key={index} style={{ marginBottom: "5px" }}>
            <View>
              <View style={{ padding: "5px 0px" }}>
                <Text style={styles.paragraphTextBold2}>
                  Flight Itinerary {index + 1}
                </Text>
              </View>
              {data.flightOffer?.itinerary?.OriginDestinationOptions.map(
                  ...
                  <View key={index}>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {
                            dictionary.locations?.[destination?.departure]
                              ?.cityName
                          }{" "}
                          -{" "}
                          {
                            dictionary.locations?.[destination?.arrival]
                              ?.cityName
                          }{" "}
                          ({" "}
                          {moment(
                      ...
                      <View>
                        ...
                        >
                          Gross Fare:{" "}
                          {
                            data?.flightOffer?.pricingInfo?.bestCombinablePrice
                              ?.currency
                          }{" "}
                          {commaNumber(
                            data?.flightOffer?.pricingInfo?.bestCombinablePrice
                          ...
                          >
                            <View style={styles.layoverRow}>
                              ...
                              >
                                ...
                                {formatDuration(
                                  Number(
                                    segment?.flightInfo?.layoverTimeInMinutes
                                  )
                                )}{" "}
                                Layover
                              </Text>
                          ...
                          <View style={{ flex: 4 }}>
                            <View style={styles.row}>
                              ...
                              <Text style={styles.text}>
                                {segment?.flightInfo?.technicalStopover
                                  ?.length === 0
                                  ? "Direct"
                                  : segment?.flightInfo?.technicalStopover
                                      ?.length + " Stop"}{" "}
                              ...
                              {Array.isArray(
                                ...
                                segment.flightInfo.technicalStopover.map(
                                  (technicalStop: any, index: number) =>
                                    index > 0 && (
                                      <View key={index}>
                                        <Text style={styles.layover}>
                                          {formatDuration(
                                            technicalStop?.duration
                                          )}{" "}
                                          -{" "}
                                          {dictionary?.locations?.[
                                            technicalStop?.airportCode
                                          ]?.cityName || ""}
                                        </Text>
                                      </View>
                                    )
...
export default SelectedFlightItinerary;
